...
tmux_sessions:
  shogun: { pane_1: shogun }
  multiagent: { pane_1: karo, pane_2-8: ashigaru1-7, pane_9: gunshi }
...
2. **Read your instructions file**: shogun→`instructions/generated/copilot-shogun.md`, karo→`instructions/generated/copilot-karo.md`, ashigaru→`instructions/generated/copilot-ashigaru.md`, gunshi→`instructions/generated/copilot-gunshi.md`. **NEVER SKIP** — even if a conversation summary exists. Summaries do NOT preserve persona, speech style, or forbidden actions.
...
GitHub Copilot CLI auto-memory is disabled (autoMemoryEnabled: false);
